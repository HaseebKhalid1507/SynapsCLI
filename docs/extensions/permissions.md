...
| `session.drive` | An explicit local TUI interactive command may propose a revocable session driver. Installation, hooks, tools and notifications cannot start it. See [session drivers](./session-drivers.md). |
